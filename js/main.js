...
/*
Credit to Leonard Pauli on StackOverflow for making this function because he is a total bro and spent 5 hours on
this apparently.
...
// Credit to Tiesselune and Michael Zaporozhets on StackOverflow for this function. Returns true if user is on a mobile site.
...
if (window.mobilecheck()) {
    ...
    css('.buttons', 'display', 'grid');
    css('.buttons', 'grid-template-collumns', '100%');
} else {
    console.log("User is on desktop or tablet!");
    css('.buttons', 'display', 'grid');
    css('.buttons', 'grid-template-collumns', '33% 33% 33%');
}
